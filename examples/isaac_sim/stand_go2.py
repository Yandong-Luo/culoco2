...
parser.add_argument("--robot", type=str, default="go2.yml", help="robot configuration to load")
parser.add_argument(
    "--external_asset_path",
    type=str,
    default=None,
...
def main():
    ...
    robot, robot_prim_path = add_robot_to_scene(robot_cfg, my_world, position=np.array([0, 0, 0.35]))
    ...
    while simulation_app.is_running():
        ...
        if args.visualize_spheres and step_index % 2 == 0:
            ...
            sph_list = kin_model.get_robot_with_multi_ee_as_spheres(cu_js.position)
