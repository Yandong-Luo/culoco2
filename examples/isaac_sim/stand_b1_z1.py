...
parser.add_argument("--robot", type=str, default="b1_z1.yml", help="robot configuration to load")
parser.add_argument(
    "--external_asset_path",
    type=str,
    default=None,
...
from curobo.cuda_loco_robot_model.cuda_robot_model import CudaLocoRobotModel
...
def main():
    ...
    print("robot_cfg_path",robot_cfg_path)
